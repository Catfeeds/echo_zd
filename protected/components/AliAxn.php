...
require_once(dirname(__FILE__) .'/../../protected/vendor/axn/vendor/autoload.php');
...
class AliAxn
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIFkPYjvzZziLB"; // AccessKeyId

        $accessKeySecret = "7CHZPrIr31QIlEh27yHfNS7qCoukoF"; // AccessKeySecret
     ...
     * @throws ClientException
     */
    public static function bindAxnExtension($key='',$noa='',$ext='',$expire='',$isrecord=true) {
        ...
        //可选:是否需要录制音频-默认是false
        $request->setIsRecordingEnabled($isrecord);
