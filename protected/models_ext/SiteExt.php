...
class SiteExt extends Site{
    ...
    public static $cateTag = [
        'qjpz'=> [
            ...
            'companynotice'=>['type'=>'text','name'=>'分销公司注册通知电话'],
            ...
            'appid'=>['type'=>'text','name'=>'小程序开发者ID','notedit'=>"1"],
            'appsecret'=>['type'=>'text','name'=>'小程序开发者密码','notedit'=>"1"],
            'appid1'=>['type'=>'text','name'=>'案场开发者ID','notedit'=>"1"],
            'appsecret1'=>['type'=>'text','name'=>'案场开发者密码','notedit'=>"1"],
            ...
            'share_pic'=>['type'=>'image','max'=>1,'name'=>'分享默认图'],
