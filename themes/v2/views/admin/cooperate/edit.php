...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $form->dropDownList($article, 'cid', CHtml::listData(CompanyExt::model()->normal()->findAll(),'id','name'), array('class' => 'form-control select2', 'empty'=>'请选择', 'encode' => false)); ?>
    </div>
...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $form->dropDownList($article, 'staff', CHtml::listData(StaffExt::model()->normal()->findAll(),'id','name_phone'), array('class' => 'form-control select2', 'empty'=>'请选择', 'encode' => false)); ?>
    </div>
...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $form->dropDownList($article, 'hid', CHtml::listData(PlotExt::model()->normal()->findAll(),'id','title'), array('class' => 'form-control select2', 'empty'=>'请选择', 'encode' => false)); ?>
    </div>
