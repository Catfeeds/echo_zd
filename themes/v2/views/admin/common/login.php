...
<head>
<meta charset="utf-8"/>
<title><?php echo $this->pageTitle=Yii::app()->file->sitename.'后台登录' ?></title>
...
<div class="content ">
	...
	<form class="login-form" action="" method="post">
		<h3 class="form-title" style="font-family: 微软雅黑"><?=Yii::app()->file->sitename?>后台登录</h3>
