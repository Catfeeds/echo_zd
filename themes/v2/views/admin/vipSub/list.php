...
<div class="table-toolbar">
    <div class="btn-group pull-left">
        <form class="form-inline">
            <div class="form-group">
                <?php echo CHtml::dropDownList('type',$type,array('title'=>'项目名','vip_phone'=>'客户手机','user_phone'=>'经纪人手机'),array('class'=>'form-control','encode'=>false)); ?>
            </div>
            <div class="form-group">
   ...
   <table class="table table-bordered table-striped table-condensed flip-content table-hover">
    ...
    <tbody>
    <?php foreach($infos as $k=>$v): $plot = $v->plot; ?>
        <tr>
            <td style="text-align:center;vertical-align: middle"><?php echo $v->id; ?></td>
            
            <td class="text-center"><?=$v->name.' '.$v->vip_phone?></td> 
            <td class="text-center"><?=$v->user?($v->user->name.$v->user_phone):$v->user_phone?></td>
