...
<div class="table-toolbar">
    <div class="btn-group pull-left">
        <form class="form-inline">
            ...
            <div class="form-group">
                <?php echo CHtml::dropDownList('sid',$sid,CHtml::listData(StaffExt::model()->findAll('status=1'),'id','name'),array('class'=>'form-control chose_select','encode'=>false,'prompt'=>'--选择员工--')); ?>
            </div>
   ...
   <table class="table table-bordered table-striped table-condensed flip-content table-hover">
    ...
    <?php foreach($infos as $k=>$v): ?>
        <tr>
            ...
            <td class="text-center"><?=Tools::u8_title_substr($v->content,100)?></td>
