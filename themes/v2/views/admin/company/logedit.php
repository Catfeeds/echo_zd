...
<div class="form-group">
    <label class="col-md-2 control-label">跟进内容</label>
    <div class="col-md-4">
...
<div class="form-group">
    <label class="col-md-2 control-label">选择添加者</label>
    <div class="col-md-4">
        <?php echo $form->dropDownList($article, 'uid',  CHtml::listData(StaffExt::model()->findAll(),'id','name_phone'), array('class'=>'form-control select2')); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'uid') ?></div>
</div>

<div class="form-group">
    <label class="col-md-2 control-label">是否修改资料</label>
    <div class="col-md-4">
        <?php echo $form->radioButtonList($article, 'is_xg', ['否','是'], array('separator' => '')); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'is_xg') ?></div>
</div>
<div class="form-actions">
    <div class="row">
        <div class="col-md-offset-3 col-md-9">
            <button type="submit" class="btn green">保存</button>
            <?php echo CHtml::link('返回',$this->createUrl('loglist',['id'=>$cid]), array('class' => 'btn default')) ?>
        </div>
    </div>
</div>
