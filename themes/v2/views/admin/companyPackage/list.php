...
<div class="table-toolbar">
   ...
   <table class="table table-bordered table-striped table-condensed flip-content table-hover">
    ...
    <tr>
        ...
        <th class="text-center">房源总数</th>
        <th class="text-center">短信总数</th>
    ...
    <?php foreach($infos as $k=>$v): ?>
        <tr>
            ...
            <td class="text-center"><?=$v->plot_num?></td>
            <td class="text-center"><?=$v->msg_num?></td> 
            <td class="text-center"><?=date('Y-m-d',$v->expire)?></td>
