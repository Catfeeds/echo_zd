<?php
	$this->pageTitle=$house->title.'点评';
	?>
    <div class="table-toolbar">
    <div class="pull-right">
        <a href="<?php echo $this->createAbsoluteUrl('editdp',['hid'=>$_GET['hid']]) ?>" class="btn blue">
    ...
    <?php foreach($infos as $v): ?>
        <tr>
            ...
            <td style="text-align:center;vertical-align: middle">
                <a href="<?php echo $this->createUrl('editdp',array('id'=>$v->id,'hid'=>$_GET['hid'])); ?>" class="btn default btn-xs green"><i class="fa fa-edit"></i> 修改 </a>
