...
<div class="table-toolbar">
    ...
    <div class="pull-right">
        <a href="<?php echo $this->createAbsoluteUrl('newseditnew') ?>" class="btn blue">
    ...
    <?php foreach($infos as $k=>$v): ?>
        <tr>
            ...
            <td style="text-align:center;vertical-align: middle">
                <a href="<?php echo $this->createUrl('newseditnew',array('id'=>$v->id)); ?>" class="btn default btn-xs green"><i class="fa fa-edit"></i> 修改 </a>
