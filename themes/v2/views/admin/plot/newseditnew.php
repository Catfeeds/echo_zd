...
<div class="form-group">
    <label class="col-md-2 control-label">楼盘<span class="required" aria-required="true">*</span></label>
    <div class="col-md-4">
        <?php echo $form->dropDownList($article, 'hid',CHtml::listData(PlotExt::model()->normal()->findAll(),'id','title'), array('class' => 'form-control select2')); ?>
    </div>
