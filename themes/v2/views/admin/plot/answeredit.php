...
<div class="form-group">
    <label class="col-md-2 control-label">问题<span class="required" aria-required="true">*</span></label>
    <div class="col-md-4">
        <?php echo $form->dropDownList($article, 'aid', CHtml::listData(PlotAskExt::model()->findAll("hid=$hid"),'id','title'),array('class' => 'form-control select2')); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'aid') ?></div>
</div>
<div class="form-group">
...
<div class="form-actions">
    <div class="row">
        <div class="col-md-offset-3 col-md-9">
            ...
            <?php echo CHtml::link('返回',$this->createUrl('answerlist',['hid'=>$hid]), array('class' => 'btn default')) ?>
        </div>
    </div>
</div>
