<?php
	$this->pageTitle=$house->title.'提问';
	?>
    <div class="table-toolbar">
    <div class="pull-right">
        <a href="<?php echo $this->createAbsoluteUrl('editask',['hid'=>$_GET['hid']]) ?>" class="btn blue">
...
<table class="table table-bordered table-striped table-condensed flip-content">
    ...
    <?php foreach($infos as $v): ?>
        <tr>
            ...
            <td style="text-align:center;vertical-align: middle" class="text-center"><?=Tools::u8_title_substr($v->title,100)?></td>
            ...
            <td style="text-align:center;vertical-align: middle">
                <a href="<?php echo $this->createUrl('editask',array('id'=>$v->id,'hid'=>$_GET['hid'])); ?>" class="btn default btn-xs green"><i class="fa fa-edit"></i> 修改 </a>
