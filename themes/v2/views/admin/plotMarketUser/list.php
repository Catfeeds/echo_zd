    ...
    <div class="btn-group pull-left">
        <form class="form-inline">
            <div class="form-group">
                <?php echo CHtml::dropDownList('type',$type,array('title'=>'项目名','phone'=>'手机号'),array('class'=>'form-control','encode'=>false)); ?>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <?php echo CHtml::dropDownList('expire',$expire,['未到期','已到期'],array('class'=>'form-control chose_select','encode'=>false,'prompt'=>'--是否到期--')); ?>
            </div>
   ...
   <table class="table table-bordered table-striped table-condensed flip-content table-hover">
    ...
    <?php foreach($infos as $k=>$v): ?>
        <tr>
            ...
            <td class="text-center"><?=($v->user?($v->user->name.'/'.$v->user->phone):'暂无').($v->is_manager&&$v->plot?('<a href="/admin/plot/edit?id='.$v->plot->id.'"> 查看发布项目</a>'):'')?></td> 
