    ...
    <?php foreach($infos as $k=>$v): ?>
        <tr>
            ...
            <td style="text-align:center;vertical-align: middle">
                ...
                <?php if($v->status==0): ?>
                    <?php echo CHtml::ajaxLink('驳回',$this->createUrl('recall'), array('type'=>'get', 'data'=>array('id'=>$v->id,'class'=>get_class($v)),'success'=>'function(data){location.reload()}'), array('class'=>'btn btn-xs '.UserExt::$statusStyle[$v->status])); ?>
                <?php endif;?>
