...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $form->dropDownList($article, 'status', SubProExt::$status, array('class' => 'form-control', 'encode' => false)); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'status') ?></div>
</div>
<div class="form-group">
    <label class="col-md-2 control-label">分销用户</label>
    <div class="col-md-4">
        <?php echo $form->dropDownList($article, 'uid', CHtml::listData(UserExt::model()->findAll(),'id','name'), array('class' => 'form-control select2', 'encode' => false,'empty'=>'请选择')); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'uid') ?></div>
</div>
<div class="form-group">
    <label class="col-md-2 control-label">市场/案场</label>
    <div class="col-md-4">
        <?php echo $form->dropDownList($article, 'staff', CHtml::listData(StaffExt::model()->findAll(),'id','name_phone'), array('class' => 'form-control select2', 'encode' => false,'empty'=>'请选择')); ?>
    </div>
...
<div class="form-actions">
    <div class="row">
        <div class="col-md-offset-3 col-md-9">
            ...
            <?php echo CHtml::link('返回',$this->createUrl('prolist',['sid'=>$sid]), array('class' => 'btn default')) ?>
        </div>
    </div>
</div>
