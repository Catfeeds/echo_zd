    ...
    <div class="btn-group pull-left">
        <form class="form-inline">
            <div class="form-group">
                <?php echo CHtml::dropDownList('type',$type,array('title'=>'域名'),array('class'=>'form-control','encode'=>false)); ?>
            </div>
            <div class="form-group">
   ...
   <table class="table table-bordered table-striped table-condensed flip-content table-hover">
    ...
    <?php foreach($infos as $k=>$v): ?>
        <tr>
            ...
            <td class="text-center"><?=$v->beian?></td>
            <td class="text-center"><?=$v->user?($v->user->name.'/'.$v->user->phone):''?></td> 
            <td class="text-center"><?=date('Y-m-d H:i:s',$v->created)?></td>
            <td style="text-align:center;vertical-align: middle">
                <a href="<?php echo $this->createUrl('plotlist',array('id'=>$v->id)); ?>" class="btn default btn-xs red"><i class="fa fa-edit"></i> 项目列表 </a>
